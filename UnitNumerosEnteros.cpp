...
{
	byte a;
	a = StrToInt( InputBox( "* PRIMEROS N NÚMEROS NATURALES INVERTIDOS", "* INGRESE UN NÚMERO: ", "0" ) );
...
{
	byte a;
	a = StrToInt( InputBox( "* PRIMEROS N NÚMEROS NATURALES PARES", "* INGRESE UN NÚMERO: ", "0" ) );
...
{
	byte a;
	a = StrToInt( InputBox( "* PRIMEROS N NÚMEROS NATURALES IMPARES", "* INGRESE UN NÚMERO: ", "0" ) );
